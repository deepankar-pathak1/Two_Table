...
<?php while($var=$sql->fetch_assoc()){?>
	<tr>
		...
		<td><a href="student_b_table.php?id=<?php echo $var['id']?>" class='btn btn-danger'>DELETE</a></td>
		<td><a href="stu_edit.php?id=<?php echo $var['id']?>" class='btn btn-info'>EDIT CLASS</a></td>
