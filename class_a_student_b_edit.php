...
if (isset($_GET['id'])){
  $id = $_GET['id'];
  $sql = mysqli_query($conn, "SELECT * FROM student_b where id='$id'");
...
<html lang="en">
<head>
  <title>EDIT_STUDENT_B_FORM</title>
  <meta charset="utf-8">
...
<body>
<div class="container">
  <h1>EDIT_STUDENT_B_DETAILS</h1><br>
  <form method="POST" action="student_b_edit_update.php">
    ...
    <div class="form-row">
      ...
      <div class="col">
        <input type="email" class="form-control" value = "<?php echo $q['email']; ?>" name="email">
      </div>
    </div>
  ...
  <br>
    ...
    <div class="form-row">
      <div class="col">
        <input type="number" class="form-control" id="number" value="<?php echo $q['phone'] ?>" name="phone">
      </div>
      <div class="col">
  ...
  <select name="drop_down">
    <option><?php echo $q['standard'] ?></option>
    <?php
